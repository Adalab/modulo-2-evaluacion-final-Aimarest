"use strict";
// Elementos que necesito traer del html:
...
function renderDrinks(list, allDrinks) {
  let html = "";
    ...
    .then(function (data) {
      ...
      for (const drink of allDrinks) {
        ...
        currentDrink.addEventListener("click", function () {
          ...
          // const currentDrinkObject = allDrinks.find(item => item.idDrink === currentDrink.id)
          ...
          debugger;
          renderDrinks(favouritesList, favourites);
        });
      }
    });
}
